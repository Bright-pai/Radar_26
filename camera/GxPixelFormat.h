...
{
	GX_COLOR_FILTER_NONE     = 0,                        ///< \Chinese ��                     \English nothing
	GX_COLOR_FILTER_BAYER_RG = 1,                        ///< \Chinese RG��ʽ                 \English RG format
	GX_COLOR_FILTER_BAYER_GB = 2,                        ///< \Chinese GB��ʽ                 \English GB format
	GX_COLOR_FILTER_BAYER_GR = 3,                        ///< \Chinese GR��ʽ                 \English GR format
	GX_COLOR_FILTER_BAYER_BG = 4,                        ///< \Chinese BG��ʽ                 \English BG format
...
typedef enum GX_PIXEL_FORMAT_ENTRY
{
    ...
    GX_PIXEL_FORMAT_ARGB8              = (GX_PIXEL_COLOR | GX_PIXEL_32BIT | 0x0018),//0x2200018,    \Chinese ��׼Э����δ����       \English The standard agreement is undefined   
    GX_PIXEL_FORMAT_ABGR8              = (GX_PIXEL_COLOR | GX_PIXEL_32BIT | 0x0019),//0x2200019,    \Chinese ��׼Э����δ����       \English The standard agreement is undefined  
	...
	GX_PIXEL_FORMAT_COORD3D_ABC32F           = (GX_PIXEL_COLOR | GX_PIXEL_96BIT | 0X00C0),//0x021800C0, \Chinese 3D ���� A-B-C 32λ��  \English 3D coordinate A-B-C 32-bit floating point 
	GX_PIXEL_FORMAT_COORD3D_ABC32F_PLANAR    = (GX_PIXEL_COLOR | GX_PIXEL_96BIT | 0X00C1),//0x021800C1, \Chinese 3D ���� A-B-C 32λ��  \English 3D coordinate A-B-C 32-bit floating point planar
	GX_PIXEL_FORMAT_COORD3D_C16              = (GX_PIXEL_MONO  | GX_PIXEL_16BIT | 0x00B8),//0x011000B8, \Chinese 3D ���� C 16λ        \English 3D coordinate C 16-bit
	GX_PIXEL_FORMAT_COORD3D_C16_I16          = (GX_PIXEL_MONO  | GX_PIXEL_16BIT | 0xFF02),//0x0110FF02, \Chinese �����Զ����ʽ        \English Vendor-defined format
	GX_PIXEL_FORMAT_COORD3D_C16_S16          = (GX_PIXEL_MONO  | GX_PIXEL_16BIT | 0xFF03),//0x0110FF03, \Chinese �����Զ����ʽ        \English Vendor-defined format
	GX_PIXEL_FORMAT_COORD3D_C16_I16_S16      = (GX_PIXEL_MONO  | GX_PIXEL_16BIT | 0xFF04),//0x0110FF04, \Chinese �����Զ����ʽ        \English Vendor-defined format
    ...
    GX_PIXEL_FORMAT_YUV420_8_PLANAR    = (GX_PIXEL_COLOR | GX_PIXEL_12BIT | 0x0040),//0x20C0040,    \Chinese ��׼Э����δ����       \English The standard agreement is undefined 
	...
	GX_PIXEL_FORMAT_MONO10_PACKED      = (GX_PIXEL_MONO  | GX_PIXEL_12BIT | 0x0004),//0x010C0004,   \Chinese ǧ���������ʽ        \English GigE Vision specific format
	GX_PIXEL_FORMAT_MONO12_PACKED      = (GX_PIXEL_MONO  | GX_PIXEL_12BIT | 0x0006),//0x010C0006,   \Chinese ǧ���������ʽ        \English GigE Vision specific format

	GX_PIXEL_FORMAT_BAYER_BG10_PACKED  = (GX_PIXEL_MONO  | GX_PIXEL_12BIT | 0x0029),//0x010C0029,   \Chinese ǧ���������ʽ        \English GigE Vision specific format
	GX_PIXEL_FORMAT_BAYER_BG12_PACKED  = (GX_PIXEL_MONO  | GX_PIXEL_12BIT | 0x002D),//0x010C002D,   \Chinese ǧ���������ʽ        \English GigE Vision specific format

    GX_PIXEL_FORMAT_BAYER_GB10_PACKED  = (GX_PIXEL_MONO  | GX_PIXEL_12BIT | 0x0028),//0x010C0028,   \Chinese ǧ���������ʽ        \English GigE Vision specific format
    GX_PIXEL_FORMAT_BAYER_GB12_PACKED  = (GX_PIXEL_MONO  | GX_PIXEL_12BIT | 0x002C),//0x010C002C,   \Chinese ǧ���������ʽ        \English GigE Vision specific format

    GX_PIXEL_FORMAT_BAYER_GR10_PACKED  = (GX_PIXEL_MONO  | GX_PIXEL_12BIT | 0x0026),//0x010C0026,   \Chinese ǧ���������ʽ        \English GigE Vision specific format
	GX_PIXEL_FORMAT_BAYER_GR12_PACKED  = (GX_PIXEL_MONO  | GX_PIXEL_12BIT | 0x002A),//0x010C002A,   \Chinese ǧ���������ʽ        \English GigE Vision specific format

    GX_PIXEL_FORMAT_BAYER_RG10_PACKED  = (GX_PIXEL_MONO  | GX_PIXEL_12BIT | 0x0027),//0x010C0027,   \Chinese ǧ���������ʽ        \English GigE Vision specific format
    GX_PIXEL_FORMAT_BAYER_RG12_PACKED  = (GX_PIXEL_MONO  | GX_PIXEL_12BIT | 0x002B),//0x010C002B,   \Chinese ǧ���������ʽ        \English GigE Vision specific format
